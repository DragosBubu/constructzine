				...
				while ( have_posts() ) {
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-footer">
							<ul>
								<li class="comments-icon"><a href="<?php the_permalink(); ?>#comments" title="<?php printf( _n( 'One Comment', '%1$s Comments', get_comments_number(), 'ti' ), number_format_i18n( get_comments_number() ), '' . get_the_title() . '' ); ?>"><?php printf( _n( 'One Comment', '%1$s Comments', get_comments_number(), 'ti' ), number_format_i18n( get_comments_number() ), '' . get_the_title() . '' ); ?></a></li>
