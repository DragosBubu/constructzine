...
				/***********************************************/	/************** COLORS OPTIONS  ***************/	/***********************************************/				$wp_customize->add_section( 'constructzine_color_section' , array(				'title'       => __( 'Colors', 'constructzine' ),				'priority'    => 210,				'description' => __('Constructzine theme colors','constructzine')		));				/* Footer background color */		$wp_customize->add_setting(			'constructzine_footer_background',			array(				'default'     => '#272727'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_footer_background',				array(					'label'      => __( 'Footer background color', 'constructzine' ),					'section'    => 'constructzine_color_section',					'settings'   => 'constructzine_footer_background',					'priority'   => 1				)			)		);		/* Footer text color */		$wp_customize->add_setting(			'constructzine_footer_text',			array(				'default'     => '#fff'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_footer_text',				array(					'label'      => __( 'Footer text color', 'constructzine' ),					'section'    => 'constructzine_color_section',					'settings'   => 'constructzine_footer_text',					'priority'   => 2				)			)		);				/* Footer title color */		$wp_customize->add_setting(			'constructzine_footer_title',			array(				'default' => '#fff'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(			$wp_customize,			'constructzine_footer_title',			array(				'label' 	=> __('Footer title color','constructzine'),				'section'   => 'constructzine_color_section',				'settings'  => 'constructzine_footer_title',				'priority'  => 3				)			)		);		/* General color - submit button */		$wp_customize->add_setting(			'constructzine_general_submit',			array(				'default' => '#FCD53A'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(			$wp_customize,			'constructzine_general_submit',			array(				'label' 	=> __('General submit color','constructzine'),				'section'   => 'constructzine_color_section',				'settings'  => 'constructzine_general_submit',				'priority'  => 4				)			)		);					/*General post title color */		$wp_customize->add_setting(			'constructzine_post_title',			array(				'default' => '#414140'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_post_title',				array(					'label'		 => __('Post title color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_post_title',					'priority'   => 5								)			)		);					/*General post text color */		$wp_customize->add_setting(			'constructzine_post_text',			array(				'default' => '#414140'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_post_text',				array(					'label'		 => __('Post text color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_post_text',					'priority'   => 6								)			)		);			/*Menu ribbon color */		$wp_customize->add_setting(			'constructzine_ribbon_color',			array(				'default' => '#fcd53a'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_ribbon_color',				array(					'label'		 => __('Menu ribbon color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_ribbon_color',					'priority'   => 7								)			)		);		/*Main title color */		$wp_customize->add_setting(			'constructzine_maintitle_color',			array(				'default' => '#333332'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_maintitle_color',				array(					'label'		 => __('Main title color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_maintitle_color',					'priority'   => 8								)			)		);		/*Sidebar title color */		$wp_customize->add_setting(			'constructzine_sidebar_title_color',			array(				'default' => '#414140'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_sidebar_title_color',				array(					'label'		 => __('Sidebar title color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_sidebar_title_color',					'priority'   => 9								)			)		);			/*Sidebar title color */		$wp_customize->add_setting(			'constructzine_sidebar_text_color',			array(				'default' => '#414140'			)		);		$wp_customize->add_control(			new WP_Customize_Color_Control(				$wp_customize,				'constructzine_sidebar_text_color',				array(					'label'		 => __('Sidebar title color','constructzine'),					'section' 	 => 'constructzine_color_section',					'settings' 	 => 'constructzine_sidebar_text_color',					'priority'   => 10								)			)		);		
	/*
